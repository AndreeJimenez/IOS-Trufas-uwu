    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 249.0, start: 37.0),
            Pin(size: 43.0, middle: 0.6467),
            child: Text(
              '¿Quienes somos?',
              style: TextStyle(
                fontFamily: 'Segoe UI',
          ...
          Pinned.fromPins(
            ...
            Pin(size: 185.0, end: 107.0),
            child: Text(
              'Ut placerat pretium mollis. Maecenas gravida tellus in tincidunt laoreet. Etiam nec ex est. Nunc nec urna hendrerit, varius erat sed, laoreet nibh. Suspendisse a mollis sapien, at suscipit est.',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
                color: const Color(0xff373737),
          ...
          Pinned.fromPins(
            Pin(start: 22.0, end: 18.0),
            Pin(size: 188.0, middle: 0.4756),
